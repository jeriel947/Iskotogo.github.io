...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2023 at 01:07 PM
...
(1, 2, 'burgir', 75, 9, 1, ''),
(2, 1, 'prech price', 56, 10, 1, ''),
(3, 1, 'spaghetti', 30, 8, 1, ''),
(4, 1, 'carbonara', 35, 6, 1, ''),
(5, 1, 'pansit', 40, 8, 1, ''),
(6, 1, 'chicken pesto', 69, 10, 1, ''),
(8, 2, 'coke', 10, 10, 1, ''),
(9, 2, 'pepsi', 12, 9, 1, ''),
(10, 2, 'root beer', 15, 8, 1, ''),
...
(8, 2, 1, 6, 1, '2023-07-17 15:13:51', 0),
(11, 13, 5, 6, 5, '2023-07-17 15:31:54', 0),
(12, 10, 2, 6, 1, '2023-07-17 22:43:47', 1),
(13, 9, 2, 6, 1, '2023-07-17 22:44:51', 0),
(14, 10, 2, 6, 1, '2023-07-19 04:57:12', 0),
(15, 6, 1, 6, 1, '2023-07-19 07:57:03', 0),
(16, 4, 1, 6, 2, '2023-07-19 15:54:59', 0),
(17, 3, 1, 6, 2, '2023-07-19 16:01:20', 0),
(18, 5, 1, 6, 1, '2023-07-19 17:25:07', 0),
(19, 5, 1, 6, 1, '2023-07-19 17:49:09', 0);
...
CREATE TABLE `tbl_orderstatus` (
  `id` int(11) NOT NULL,
  `order_status_id` tinyint(11) DEFAULT NULL,
...
INSERT INTO `tbl_orderstatus` (`id`, `order_status_id`, `status`) VALUES
(1, 0, 'inactive'),
(2, 1, 'active'),
(3, 2, 'for-pickup');
...
(1, 12, 'Jabee', 'PUP Main Lagoon', '', NULL, ''),
...
(6, 'Capili', 'Mia Carryl', 'Valentino', '2020-02405-MN-0', '2020-02405-MN-0', 2, 'iskolarngbayan101', 'BSCS 3-4', 'images/users/6-image.jpg'),
...
(11, 'Doe', 'John', NULL, 'Admin', NULL, 3, '1111', NULL, NULL),
...
ALTER TABLE `tbl_orders`
  ...
  ADD CONSTRAINT `tbl_orders_ibfk_4` FOREIGN KEY (`order_status`) REFERENCES `tbl_orderstatus` (`order_status_id`);
